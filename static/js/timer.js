...
function handleLevelList(list, current) {
  var html =
    '<li><div class="item-content"><div class="item-media"><i class="icon icon-form-name"></i></div><div class="item-inner"><div class="item-title">级别</div><div class="item-after">小盲</div><div class="item-after">大盲</div><div class="item-after">ante</div></div></div></li>';
  for (var i = 0, L = list.length; i < L; i++) {
    ...
    html +=
      '<li class="' +
      className +
      '"><div class="item-content"><div class="item-media"><i class="icon icon-form-name"></i></div><div class="item-inner">' +
