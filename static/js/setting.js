...
function handleLevelList() {
  var html = '<li><div class="item-content"><div class="item-media"><i class="icon icon-form-name"></i></div><div class="item-inner"><div class="item-title">级别</div><div class="item-after">小盲</div><div class="item-after">大盲</div><div class="item-after">ante</div><div class="item-after" style="visibility:hidden;">操作</div></div></div></li>'
  for (var i = 0, L = levelList.length; i < L; i++) {
    var level = levelList[ i ]
    html += '<li><div class="item-content"><div class="item-media"><i class="icon icon-form-name"></i></div><div class="item-inner">' +
